...
// Questions array
var questions = [{
    question: "Who was the first Red Ranger?",
    answerList: ["Jason", "Billy", "Kimberly", "Zach"],
    answer: 0
}, {
    question: "Created the Power Rangers?",
    answerList: ["Zordon", "Alpha", "Rita", "Power Stones"],
    answer: 0
}, {
    question: "Who was the Green Ranger?",
    answerList: ["Rodney", "Peter", "Julia", "Tommy"],
    answer: 3
}, {
    question: "What was Zordon's assistant's name",
    answerList: ["Beta", "Zordon Jr", "Roger", "Alpha"],
    answer: 3
}, {
    question: "All of the zords combined make the ______?",
    answerList: ["Giant Robot", "Mega Zord", "Dragon Zord", "Demon Slayer"],
    answer: 1
}, {
    question: "Who would've been the best power ranger",
    answerList: ["Rodney", "Rodney", "Rodney", "Rodney"],
    answer: 0
}];
